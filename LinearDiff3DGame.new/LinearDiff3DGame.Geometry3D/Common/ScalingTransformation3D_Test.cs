...
namespace LinearDiff3DGame.Geometry3D.Common
{
    ...
    public class ScalingTransformation3D_Test
    {
        ...
        public void RevereseMatrix()
        {
            ...
            ApproxComp comparer = new ApproxComp(epsilon);
            MatrixComparer matrixComparer = new MatrixComparer();
            Assert.IsTrue(matrixComparer.Equals(comparer, matrixMultiplication, Matrix.IdentityMatrix(3)));
        }
