...
{
	public class PolyhedronSide3DBinarySerializer : ISerializer<IPolyhedronSide3D>
	{
		public PolyhedronSide3DBinarySerializer(IDictionary<Int32, IPolyhedronVertex3D> vertexDictionary)
		{
			this.vertexDictionary = vertexDictionary;
		}

		public void Serialize(Stream storage, IPolyhedronSide3D serializableObject)
		{
		...
		public IPolyhedronSide3D Deserialize(Stream storage)
		{
			...
			IList<IPolyhedronVertex3D> sideVertexes = new List<IPolyhedronVertex3D>(sideVertexesDescription.Item1);
		...
		private readonly IDictionary<Int32, IPolyhedronVertex3D> vertexDictionary;
