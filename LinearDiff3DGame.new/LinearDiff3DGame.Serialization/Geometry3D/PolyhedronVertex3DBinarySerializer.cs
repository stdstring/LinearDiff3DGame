...
{
	public class PolyhedronVertex3DBinarySerializer : ISerializer<IPolyhedronVertex3D>
	{
		public void Serialize(Stream storage, IPolyhedronVertex3D serializableObject)
		{
		...
		public IPolyhedronVertex3D Deserialize(Stream storage)
		{
