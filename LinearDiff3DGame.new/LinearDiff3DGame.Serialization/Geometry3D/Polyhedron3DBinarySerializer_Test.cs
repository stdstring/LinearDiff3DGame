...
{
	[TestFixture]
	public class Polyhedron3DBinarySerializer_Test : SerializerTest<IPolyhedron3D>
	{
		...
		{
			IPolyhedron3D data = TestDataGenerator.GetPolyhedron(scaleCoeff);
			...
			foreach (IPolyhedronSide3D side in data.SideList)
			{
