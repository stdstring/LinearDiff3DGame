...
{
    public static unsafe class OpenGLImport
    {
        ...
        public struct LAYERPLANEDESCRIPTOR
        {
            public void Init()
            {
                nSize = (ushort)sizeof(LAYERPLANEDESCRIPTOR);
            }
        ...
        public static extern int wglCopyContext(IntPtr hglrcSrc, IntPtr hglrcDst, uint mask);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern IntPtr wglCreateContext(IntPtr hdc);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern IntPtr wglCreateLayerContext(IntPtr hdc, int iLayerPlane);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern int wglDeleteContext(IntPtr hglrc);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern int wglDescribeLayerPlane(IntPtr hdc,
                                                       int iPixelFormat,
                                                       int iLayerPlane,
                                                       uint nBytes,
                                                       ref LAYERPLANEDESCRIPTOR plpd);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern int wglGetLayerPaletteEntries(IntPtr hdc,
                                                           int iLayerPlane,
                                                           int iStart,
                                                           int cEntries,
                                                           uint* pcr);
        ...
        // PROC ???
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void* wglGetProcAddress(String lpszProc);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern int wglMakeCurrent(IntPtr hdc, IntPtr hglrc);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern int wglRealizeLayerPalette(IntPtr hdc, int iLayerPlane, int bRealize);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern int wglSetLayerPaletteEntries(IntPtr hdc,
                                                           int iLayerPlane,
                                                           int iStart,
                                                           int cEntries,
                                                           uint* pcr);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern int wglSwapLayerBuffers(IntPtr hdc, uint fuPlanes);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern int wglUseFontBitmaps(IntPtr hdc,
                                                   uint first,
                                                   uint count,
                                                   uint listBase);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern int wglUseFontOutlines(IntPtr hdc,
                                                    uint first,
                                                    uint count,
                                                    uint listBase,
                                                    float deviation,
        ...
        public const Byte GL_EXT_vertex_array = 1,
                          GL_EXT_bgra = 1,
        ...
        public const Int32 GL_COLOR_TABLE_FORMAT_EXT = 0x80D8,
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glBitmap(int width,
                                           int height,
                                           float xorig,
                                           float yorig,
                                           float xmove,
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glCopyTexImage1D(uint target,
                                                   int level,
                                                   uint internalFormat,
                                                   int x,
                                                   int y,
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glCopyTexImage2D(uint target,
                                                   int level,
                                                   uint internalFormat,
                                                   int x,
                                                   int y,
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glCopyTexSubImage1D(uint target,
                                                      int level,
                                                      int xoffset,
                                                      int x,
                                                      int y,
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glCopyTexSubImage2D(uint target,
                                                      int level,
                                                      int xoffset,
                                                      int yoffset,
                                                      int x,
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glEdgeFlagPointer(int stride, void* pointer);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glFogfv(uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glFogi(uint pname, int param);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glFogiv(uint pname, int* paramList);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetBooleanv(uint pname, byte* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetClipPlane(uint plane, double* equation);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetDoublev(uint pname, double* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern uint glGetError();

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetFloatv(uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetIntegerv(uint pname, int* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetLightfv(uint light, uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetLightiv(uint light, uint pname, int* paramList);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetMaterialfv(uint face, uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetMaterialiv(uint face, uint pname, int* paramList);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetPointerv(uint pname, void** paramList);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetTexEnvfv(uint target, uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetTexEnviv(uint target, uint pname, int* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetTexGendv(uint coord, uint pname, double* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetTexGenfv(uint coord, uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetTexGeniv(uint coord, uint pname, int* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetTexImage(uint target, int level, uint format, uint type, void* pixels);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetTexLevelParameterfv(uint target, int level, uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetTexLevelParameteriv(uint target, int level, uint pname, int* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetTexParameterfv(uint target, uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glGetTexParameteriv(uint target, uint pname, int* paramList);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glIndexPointer(uint type, int stride, void* pointer);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glLightModelfv(uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glLightModeli(uint pname, int param);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glLightModeliv(uint pname, int* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glLightf(uint light, uint pname, float param);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glLightfv(uint light, uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glLighti(uint light, uint pname, int param);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glLightiv(uint light, uint pname, int* paramList);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glListBase(uint baseValue);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glMap2d(uint target,
                                          double u1,
                                          double u2,
                                          int ustride,
                                          int uorder,
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glMap2f(uint target,
                                          float u1,
                                          float u2,
                                          int ustride,
                                          int uorder,
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glMaterialfv(uint face, uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glMateriali(uint face, uint pname, int param);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glMaterialiv(uint face, uint pname, int* paramList);
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexEnvfv(uint target, uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexEnvi(uint target, uint pname, int param);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexEnviv(uint target, uint pname, int* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexGend(uint coord, uint pname, double param);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexGendv(uint coord, uint pname, double* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexGenf(uint coord, uint pname, float param);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexGenfv(uint coord, uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexGeni(uint coord, uint pname, int param);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexGeniv(uint coord, uint pname, int* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexImage1D(uint target,
                                               int level,
                                               int internalformat,
                                               int width,
                                               int border,
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexImage2D(uint target,
                                               int level,
                                               int internalformat,
                                               int width,
                                               int height,
        ...
        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexParameterfv(uint target, uint pname, float* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexParameteri(uint target, uint pname, int param);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexParameteriv(uint target, uint pname, int* paramList);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexSubImage1D(uint target, int level, int xoffset, int width, uint format, uint type, void* pixels);

        [DllImport("opengl32.dll", SetLastError = true)]
        public static extern void glTexSubImage2D(uint target,
                                                  int level,
                                                  int xoffset,
                                                  int yoffset,
                                                  int width,
        ...
        // или usort ???
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern char* gluErrorUnicodeStringEXT(uint errCode);
        ...
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluLookAt(double eyex,
                                            double eyey,
                                            double eyez,
                                            double centerx,
                                            double centery,
        ...
        // double  modelMatrix[16], double  projMatrix[16], int viewport[4]
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern int gluScaleImage(uint format,
                                               int widthin,
                                               int heightin,
                                               uint typein,
                                               void* datain,
        ...
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern int gluBuild1DMipmaps(uint target,
                                                   int components,
                                                   int width,
                                                   uint format,
                                                   uint type,
        ...
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern int gluBuild2DMipmaps(uint target,
                                                   int components,
                                                   int width,
                                                   int height,
                                                   uint format,
        ...
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluCylinder(GLUquadric* qobj,
                                              double baseRadius,
                                              double topRadius,
                                              double height,
                                              int slices,
        ...
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluDisk(GLUquadric* qobj,
                                          double innerRadius,
                                          double outerRadius,
                                          int slices,
                                          int loops);
        ...
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluPartialDisk(GLUquadric* qobj,
                                                 double innerRadius,
                                                 double outerRadius,
                                                 int slices,
                                                 int loops,
        ...
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluSphere(GLUquadric* qobj,
                                            double radius,
                                            int slices,
                                            int stacks);

        // TODO : void (CALLBACK* fn)()); - delegate void fn(); ???
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluQuadricCallback(GLUquadric* qobj,
                                                     uint which,
                                                     void* fn);
        ...
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluTessBeginPolygon(GLUtesselator* tess, void* polygon_data);
        ...
        // double coords[3]
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluTessVertex(GLUtesselator* tess,
                                                double[] coords,
                                                void* data);
        ...
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluTessProperty(GLUtesselator* tess, uint which, double value);

        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluTessNormal(GLUtesselator* tess, double x, double y, double z);

        // TODO : void (CALLBACK* fn)()); - delegate void fn(); ???
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluTessCallback(GLUtesselator* tess,
                                                  uint which,
                                                  void* fn);

        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluGetTessProperty(GLUtesselator* tess,
                                                     uint which,
                                                     double* value);
        ...
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluDeleteNurbsRenderer(GLUnurbs* nobj);

        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluBeginSurface(GLUnurbs* nobj);

        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluBeginCurve(GLUnurbs* nobj);

        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluEndCurve(GLUnurbs* nobj);

        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluEndSurface(GLUnurbs* nobj);

        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluBeginTrim(GLUnurbs* nobj);

        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluEndTrim(GLUnurbs* nobj);

        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluPwlCurve(GLUnurbs* nobj,
                                              int count,
                                              float* array,
                                              int stride,
                                              uint type);
        ...
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluNurbsCurve(GLUnurbs* nobj,
                                                int nknots,
                                                float* knot,
                                                int stride,
                                                float* ctlarray,
        ...
        // float modelMatrix[16], float projMatrix[16], int viewport[4]
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluLoadSamplingMatrices(GLUnurbs* nobj,
                                                          float[] modelMatrix,
                                                          float[] projMatrix,
                                                          int[] viewport);

        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluNurbsProperty(GLUnurbs* nobj, uint property, float value);

        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluGetNurbsProperty(GLUnurbs* nobj, uint property, float* value);

        // TODO : void (CALLBACK* fn)()); - delegate void fn(); ???
        [DllImport("glu32.dll", SetLastError = true)]
        public static extern void gluNurbsCallback(GLUnurbs* nobj,
                                                   uint which,
                                                   void* fn);
        ...
        public const byte GLU_VERSION_1_1 = 1,
                          GLU_VERSION_1_2 = 1;
        ...
        public const uint GLU_TRUE = GL_TRUE,
                          GLU_FALSE = GL_FALSE;
