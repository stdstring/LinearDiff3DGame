...
{
    public /*internal*/ sealed class BridgeGraphCorrector_new_2 : IBridgeGraphCorrector
    {
...
#warning может более специализированное исключение
                                           ...
                                           SuspiciousConnectionSet connSet)
        {
            ...
            IList<Polyhedron3DGraphNode> sectorNodes = new List<Polyhedron3DGraphNode>();
            ...
            if(sectorNodes.Count > 3)
            {
                ...
                IList<Pair<Polyhedron3DGraphNode, Polyhedron3DGraphNode>> nodePairList =
                    new List<Pair<Polyhedron3DGraphNode, Polyhedron3DGraphNode>>();
                triangulator.Action(sectorNodes, nodePairList);
                foreach(Pair<Polyhedron3DGraphNode, Polyhedron3DGraphNode> nodePair in nodePairList)
