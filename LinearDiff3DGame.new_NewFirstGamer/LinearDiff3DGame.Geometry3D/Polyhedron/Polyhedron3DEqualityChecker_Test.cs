...
namespace LinearDiff3DGame.Geometry3D.Polyhedron
{
    ...
    public class Polyhedron3DEqualityChecker_Test
    {
        ...
        {
            Polyhedron3D polyhedron1 = CreatePolyhedron(new Point3D(1, 1, 1),
                                                        new Point3D(1, -1, 1),
                                                        new Point3D(-1, 1, 1),
                                                        new Point3D(-1, -1, 1),
                                                        new Point3D(1, 1, -1),
                                                        ...
                                                        new Point3D(-1, 1, -1),
                                                        new Point3D(-1, -1, -1));
            Polyhedron3D polyhedron2 = CreatePolyhedron(new Point3D(1, 1, 1.0001),
        ...
        public void PolyhedronsNonEquality()
        {
            Polyhedron3D polyhedron1 = CreatePolyhedron(new Point3D(1, 1, 1),
                                                        ...
                                                        new Point3D(-1, 1, -1),
                                                        new Point3D(-1, -1, -1));
            Polyhedron3D polyhedron2 = CreatePolyhedron(new Point3D(1, 1, 1.1),
                                                        new Point3D(1, -1.0001, 1),
                                                        new Point3D(-1, 1.0001, 1),
        ...
        private static Polyhedron3D CreatePolyhedron(params Point3D[] vertexes)
        {
