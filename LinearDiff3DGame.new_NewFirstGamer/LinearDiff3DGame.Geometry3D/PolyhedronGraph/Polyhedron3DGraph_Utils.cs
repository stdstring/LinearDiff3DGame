...
namespace LinearDiff3DGame.Geometry3D.PolyhedronGraph
{
    ...
    {
        public Polyhedron3DGraphNode FindOppositeNode(Polyhedron3DGraph graph,
                                                      Polyhedron3DGraphNode graphNode)
        {
            Vector3D oppositeNormal = new Vector3D(-graphNode.NodeNormal.XCoord,
                                                   -graphNode.NodeNormal.YCoord,
                                                   -graphNode.NodeNormal.ZCoord);
            Polyhedron3DGraphNode oppositeNode = null;
        ...
        // направление, толщина
        public Pair<Vector3D, Double> CalcThickness(Polyhedron3DGraphNode node,
                                                    Polyhedron3DGraphNode oppositeNode)
        {
        ...
        public IDictionary<String, Pair<Vector3D, Double>> CalcGraphExtremeThickness(Polyhedron3DGraph graph)
        {
            ...
            foreach(Polyhedron3DGraphNode node in graph.NodeList)
            {
                Polyhedron3DGraphNode oppositeNode = FindOppositeNode(graph, node);
