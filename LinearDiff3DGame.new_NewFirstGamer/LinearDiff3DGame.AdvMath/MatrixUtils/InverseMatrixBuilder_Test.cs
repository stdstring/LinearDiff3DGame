...
namespace LinearDiff3DGame.AdvMath.MatrixUtils
{
    ...
    public class InverseMatrixBuilder_Test
    {
        ...
        public void TestInverseMatrixBuilding()
        {
            ...
            Matrix matrixA1 = new Matrix(3, 3);
            matrixA1[1, 1] = 2;
            matrixA1[1, 2] = 1;
            matrixA1[1, 3] = -1;
            matrixA1[2, 1] = 5;
            ...
            Matrix inverseMatrix1 = new InverseMatrixBuilder().InverseMatrix(matrixA1);

            Matrix deltaMatrix1 = (matrixA1 * inverseMatrix1) - identityMatrix;
            Double euclidNorm1 = CalcEuclidNorm(deltaMatrix1);

            Assert.IsTrue(ac.LE(euclidNorm1, 0));

            Matrix matrixA2 = new Matrix(3, 3);
            matrixA2[1, 1] = 20;
            matrixA2[1, 2] = 11;
            matrixA2[1, 3] = -1;
            matrixA2[2, 1] = 51;
            ...
            Matrix inverseMatrix2 = new InverseMatrixBuilder().InverseMatrix(matrixA2);

            Matrix deltaMatrix2 = (matrixA2 * inverseMatrix2) - identityMatrix;
            Double euclidNorm2 = CalcEuclidNorm(deltaMatrix2);

            Assert.IsTrue(ac.LE(euclidNorm2, 0));
        }

        private static Double CalcEuclidNorm(Matrix source)
        {
            Double euclidNorm = 0;
