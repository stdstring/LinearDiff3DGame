...
{
    [TestFixture]
    public class PolyhedronVertex3DBinarySerializer_Test : SerializerTest<PolyhedronVertex3D>
    {
        ...
        private static readonly PolyhedronVertex3D data = new PolyhedronVertex3D(1.11, 2.22, 3.33, 12);
    }
}