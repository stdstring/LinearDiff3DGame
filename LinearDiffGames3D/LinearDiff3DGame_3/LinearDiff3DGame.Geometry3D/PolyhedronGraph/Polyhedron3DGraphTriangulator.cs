...
namespace LinearDiff3DGame.Geometry3D
{
    ...
    /// </summary>
    public class Polyhedron3DGraphTriangulator
    {
        /// <summary>
        /// конструктор класса Polyhedron3DGraphTriangulator
        /// </summary>
        public Polyhedron3DGraphTriangulator()
        {
        }
        ...
        public Polyhedron3DGraph Triangulate(Polyhedron3DGraph graph)
        {
            ...
            for (Int32 nodeIndex = 0; nodeIndex < nodeList.Count; ++nodeIndex)
            {
                ...
                for (Int32 connIndex = 0; connIndex < currentNode.ConnectionList.Count; )
                {
                    ...
                    List<Polyhedron3DGraphNode> shortestGraphPath = GetShortestGraphPath(currentNode, currentConn, nextConn);
...
#warning может более специализированное исключение
                    ...
                    for (Int32 graphPathIndex = 1; graphPathIndex < shortestGraphPath.Count - 1; graphPathIndex++)
                    {
                        ...
                        Int32 index = shortestGraphPath[graphPathIndex].ConnectionList.IndexOf(shortestGraphPath[graphPathIndex - 1]);
        ...
        private List<Polyhedron3DGraphNode> GetShortestGraphPath(Polyhedron3DGraphNode startNode, Polyhedron3DGraphNode startConn, Polyhedron3DGraphNode finishConn)
        {
