...
namespace LinearDiff3DGame.MaxStableBridge
{
    public class BridgeBuilder
    {
        ...
        // TODO : реFUCKторинг
        public IPolyhedron3D NextIteration()
        {
            CheckAndScaleIfNeed();
            InverseTime += deltaT;
            ...
            Polyhedron3DFromGraphFactory polyhedronFactory = new Polyhedron3DFromGraphFactory(approxComp,
                                                                                              new LESKramer3Solver());

            // currentTSectionGraph = NormalizeGraph(currentTSectionGraph);
            IPolyhedron3D intermediateTSection = polyhedronFactory.CreatePolyhedron(currentTSectionGraph);
        ...
        public IPolyhedron3D CurrentTSection { get; private set; }
        ...
        private IPolyhedron3D GetCurrentTSection(IPolyhedron3DGraph sourceGraph)
        {
            // Обязательно здесь сделать копию !!! у нас граф до сих пор мьютабелен
            IPolyhedron3DGraph graph = new Polyhedron3DGraph(sourceGraph);
            Polyhedron3DGraph_ScaleTransformer transformer =
                new Polyhedron3DGraph_ScaleTransformer();
        ...
        private IPolyhedron3DGraph currentTSectionGraph;
