...
namespace LinearDiff3DGame.MaxStableBridge.Check
{
    internal class AxialSymmetryCheck
    {
        ...
        public Boolean Check(IPolyhedron3DGraph graph, Vector3D axis)
        {
            ...
            {
                IPolyhedron3DGraphNode node1 = graph.NodeList[node1Index];
                ...
                IPolyhedron3DGraphNode node2 = FindSymmetricNode(graph, axis, node1Index, checkedNodes);
                if(node2 != null)
                {
                    checkedNodes.Add(node1.ID, null);
        ...
        private IPolyhedron3DGraphNode FindSymmetricNode(IPolyhedron3DGraph graph,
                                                         Vector3D axis,
                                                         Int32 node1Index,
                                                         IDictionary<Int32, Object> checkedNodes)
        {
            IPolyhedron3DGraphNode node1 = graph.NodeList[node1Index];
            ...
            {
                IPolyhedron3DGraphNode node2 = graph.NodeList[node2Index];
                ...
                Double mixedProduct = Vector3DUtils.MixedProduct(node1.NodeNormal, node2.NodeNormal, axis);
        ...
        private Boolean IsNodeOnAxis(IPolyhedron3DGraphNode node1, Vector3D axis)
        {
            return m_ApproxComp.EQ(Vector3DUtils.VectorProduct(node1.NodeNormal, axis).Length, 0);
        }
