...
namespace LinearDiff3DGame.Serialization.Geometry3D
{
    internal class Point3DBinarySerializer : ISerializer<Point3D>
    {
        ...
        {
            doubleBinarySerializer.Serialize(storage, serializableObject.X);
            doubleBinarySerializer.Serialize(storage, serializableObject.Y);
            doubleBinarySerializer.Serialize(storage, serializableObject.Z);
        }
