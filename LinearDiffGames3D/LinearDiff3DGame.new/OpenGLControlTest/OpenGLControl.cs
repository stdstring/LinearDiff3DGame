...
namespace OpenGLControlTest
{
    ...
    public unsafe class OpenGLControl : UserControl
    {
        ...
        [DllImport("opengl32.dll")]
        public static extern unsafe byte glAreTexturesResident(int n, uint* textures, byte* residences);
        ...
        [DllImport("opengl32.dll")]
        public static extern unsafe void glEdgeFlagPointer(int stride, byte* pointer);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glEdgeFlagv(byte* flag);
        ...
        [DllImport("opengl32.dll")]
        public static extern unsafe void glFogfv(uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern void glFogi(uint pname, int param);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glFogiv(uint pname, int* someParams);
        ...
        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetBooleanv(uint pname, byte* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetClipPlane(uint plane, double* equation);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetDoublev(uint pname, double* someParams);

        [DllImport("opengl32.dll")]
        public static extern uint glGetError();

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetFloatv(uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetIntegerv(uint pname, int* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetLightfv(uint light, uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetLightiv(uint light, uint pname, int* someParams);
        ...
        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetMaterialfv(uint face, uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetMaterialiv(uint face, uint pname, int* someParams);
        ...
        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetPointerv(uint pname, void** someParams);
        ...
        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetTexEnvfv(uint target, uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetTexEnviv(uint target, uint pname, int* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetTexGendv(uint coord, uint pname, double* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetTexGenfv(uint coord, uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetTexGeniv(uint coord, uint pname, int* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetTexImage(uint target, int level, uint format, uint type, void* pixels);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetTexLevelParameterfv(uint target, int level, uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetTexLevelParameteriv(uint target, int level, uint pname, int* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetTexParameterfv(uint target, uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glGetTexParameteriv(uint target, uint pname, int* someParams);
        ...
        [DllImport("opengl32.dll")]
        public static extern unsafe void glLightModelfv(uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern void glLightModeli(uint pname, int param);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glLightModeliv(uint pname, int* someParams);

        [DllImport("opengl32.dll")]
        public static extern void glLightf(uint light, uint pname, float param);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glLightfv(uint light, uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern void glLighti(uint light, uint pname, int param);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glLightiv(uint light, uint pname, int* someParams);
        ...
        [DllImport("opengl32.dll")]
        public static extern unsafe void glMaterialfv(uint face, uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern void glMateriali(uint face, uint pname, int param);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glMaterialiv(uint face, uint pname, int* someParams);
        ...
        [DllImport("opengl32.dll")]
        public static extern unsafe void glTexEnvfv(uint target, uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern void glTexEnvi(uint target, uint pname, int param);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glTexEnviv(uint target, uint pname, int* someParams);

        [DllImport("opengl32.dll")]
        public static extern void glTexGend(uint coord, uint pname, double param);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glTexGendv(uint coord, uint pname, double* someParams);

        [DllImport("opengl32.dll")]
        public static extern void glTexGenf(uint coord, uint pname, float param);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glTexGenfv(uint coord, uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern void glTexGeni(uint coord, uint pname, int param);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glTexGeniv(uint coord, uint pname, int* someParams);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glTexImage1D(uint target, int level, int components, int width, int border, uint format, uint type, void* pixels);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glTexImage2D(uint target, int level, int components, int width, int height, int border, uint format, uint type, void* pixels);

        [DllImport("opengl32.dll")]
        public static extern void glTexParameterf(uint target, uint pname, float param);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glTexParameterfv(uint target, uint pname, float* someParams);

        [DllImport("opengl32.dll")]
        public static extern void glTexParameteri(uint target, uint pname, int param);

        [DllImport("opengl32.dll")]
        public static extern unsafe void glTexParameteriv(uint target, uint pname, int* someParams);
        ...
        public const UInt32 GLU_TRUE = GL_TRUE,
                            GLU_FALSE = GL_FALSE;
        ...
        public const UInt32 GLU_TESS_BEGIN = 100100, /* void (CALLBACK*)(GLenum    type)  */
        ...
        public const UInt32 GLU_TESS_MISSING_BEGIN_POLYGON = GLU_TESS_ERROR1,
        ...
        public const UInt32 GLU_BEGIN = GLU_TESS_BEGIN,
        ...
        [DllImport("glu32.dll")]
        public static extern unsafe Byte* gluErrorString(UInt32 errCode);

        [DllImport("glu32.dll")]
        public static extern String gluErrorUnicodeStringEXT(UInt32 errCode);

        [DllImport("glu32.dll")]
        public static extern unsafe Byte* gluGetString(UInt32 name);
        ...
        [DllImport("glu32.dll")]
        public static extern void gluPickMatrix(Double x, Double y, Double width, Double height, Int32[] viewport /*Int32[4]*/);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluPickMatrix(Double x, Double y, Double width, Double height, Int32* viewport);
        ...
        [DllImport("glu32.dll")]
        public static extern unsafe Int32 gluProject(Double objx, Double objy, Double objz, Double* modelMatrix, Double* projMatrix, Int32* viewport, Double* winx, Double* winy, Double* winz);

        [DllImport("glu32.dll")]
        public static extern unsafe Int32 gluUnProject(Double winx, Double winy, Double winz, Double* modelMatrix, Double* projMatrix, Int32* viewport, Double* objx, Double* objy, Double* objz);

        [DllImport("glu32.dll")]
        public static extern unsafe Int32 gluScaleImage(UInt32 format, Int32 widthin, Int32 heightin, UInt32 typein, void* datain, Int32 widthout, Int32 heightout, UInt32 typeout, void* dataout);

        [DllImport("glu32.dll")]
        public static extern unsafe Int32 gluBuild1DMipmaps(UInt32 target, Int32 components, Int32 width, UInt32 format, UInt32 type, void* data);

        [DllImport("glu32.dll")]
        public static extern unsafe Int32 gluBuild2DMipmaps(UInt32 target, Int32 components, Int32 width, Int32 height, UInt32 format, UInt32 type, void* data);
        ...
        [DllImport("glu32.dll")]
        public static extern unsafe GLUquadric* gluNewQuadric();

        [DllImport("glu32.dll")]
        public static extern unsafe void gluDeleteQuadric(GLUquadric* state);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluQuadricNormals(GLUquadric* quadObject, UInt32 normals);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluQuadricTexture(GLUquadric* quadObject, Byte textureCoords);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluQuadricOrientation(GLUquadric* quadObject, UInt32 orientation);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluQuadricDrawStyle(GLUquadric* quadObject, UInt32 drawStyle);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluCylinder(GLUquadric* qobj, Double baseRadius, Double topRadius, Double height, Int32 slices, Int32 stacks);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluDisk(GLUquadric* qobj, Double innerRadius, Double outerRadius, Int32 slices, Int32 loops);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluPartialDisk(GLUquadric* qobj, Double innerRadius, Double outerRadius, Int32 slices, Int32 loops, Double startAngle, Double sweepAngle);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluSphere(GLUquadric* qobj, Double radius, Int32 slices, Int32 stacks);

        /*[DllImport("glu32.dll")]
        public unsafe static extern void gluQuadricCallback(GLUquadric* qobj, UInt32 which, void (CALLBACK* fn)());*/

        [DllImport("glu32.dll")]
        public static extern unsafe GLUtesselator* gluNewTess();

        [DllImport("glu32.dll")]
        public static extern unsafe void gluDeleteTess(GLUtesselator* tess);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluTessBeginPolygon(GLUtesselator* tess, void* polygon_data);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluTessBeginContour(GLUtesselator* tess);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluTessVertex(GLUtesselator* tess, Double* coords, void* data);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluTessEndContour(GLUtesselator* tess);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluTessEndPolygon(GLUtesselator* tess);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluTessProperty(GLUtesselator* tess, UInt32 which, Double value);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluTessNormal(GLUtesselator* tess, Double x, Double y, Double z);

        /*[DllImport("glu32.dll")]
        public unsafe static extern void gluTessCallback(GLUtesselator* tess, UInt32 which, void (CALLBACK *fn)());*/

        [DllImport("glu32.dll")]
        public static extern unsafe void gluGetTessProperty(GLUtesselator* tess, UInt32 which, Double* value);

        [DllImport("glu32.dll")]
        public static extern unsafe GLUnurbs* gluNewNurbsRenderer();

        [DllImport("glu32.dll")]
        public static extern unsafe void gluDeleteNurbsRenderer(GLUnurbs* nobj);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluBeginSurface(GLUnurbs* nobj);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluBeginCurve(GLUnurbs* nobj);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluEndCurve(GLUnurbs* nobj);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluEndSurface(GLUnurbs* nobj);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluBeginTrim(GLUnurbs* nobj);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluEndTrim(GLUnurbs* nobj);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluPwlCurve(GLUnurbs* nobj, Int32 count, Single* array, Int32 stride, UInt32 type);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluNurbsCurve(GLUnurbs* nobj, Int32 nknots, Single* knot, Int32 stride, Single* ctlarray, Int32 order, UInt32 type);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluNurbsSurface(GLUnurbs* nobj, Int32 sknot_count, Single* sknot, Int32 tknot_count, Single* tknot, Int32 s_stride, Int32 t_stride, Single* ctlarray, Int32 sorder, Int32 torder, UInt32 type);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluLoadSamplingMatrices(GLUnurbs* nobj, Single* modelMatrix, Single* projMatrix, Int32* viewport);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluNurbsProperty(GLUnurbs* nobj, UInt32 property, Single value);

        [DllImport("glu32.dll")]
        public static extern unsafe void gluGetNurbsProperty(GLUnurbs* nobj, UInt32 property, Single* value);

        /*[DllImport("glu32.dll")]
        public unsafe static extern void gluNurbsCallback(GLUnurbs* nobj, UInt32 which, void (CALLBACK* fn)());*/
        ...
        public static extern unsafe Int32 ChoosePixelFormat(IntPtr hdc, ref PIXELFORMATDESCRIPTOR ppfd);

        [DllImport("gdi32.dll", SetLastError = true)]
        public static extern unsafe Int32 SetPixelFormat(IntPtr hdc, Int32 iPixelFormat, ref PIXELFORMATDESCRIPTOR ppfd);
        ...
        /// </summary>
        public /*protected*/ void ActivateContext()
        {
            Debug.Assert(wglGetCurrentContext() == IntPtr.Zero && wglGetCurrentDC() == IntPtr.Zero, "The OpenGL context is already activated.");
        ...
        /// </summary>
        public /*protected*/ void DeactivateContext()
        {
            Debug.Assert(wglGetCurrentContext() != IntPtr.Zero && wglGetCurrentDC() != IntPtr.Zero, "The OpenGL context is already deactivated.");
            wglMakeCurrent(IntPtr.Zero, IntPtr.Zero);
        }
        ...
        {
            return ToBitmap(PixelFormat.Format24bppRgb);
        }
        ...
        /// <returns>A Bitmap object, that contains a screen shot of the OpenGL window.</returns>
        protected Bitmap ToBitmap(PixelFormat pf)
        {
            ActivateContext();
            ...
            BitmapData bdata = bmp.LockBits(rect, ImageLockMode.ReadWrite, pf);
