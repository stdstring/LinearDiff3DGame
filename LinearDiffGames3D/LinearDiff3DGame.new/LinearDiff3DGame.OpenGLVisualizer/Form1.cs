...
using LinearDiff3DGame.OpenGLVisualizer.BridgeController;
...
namespace LinearDiff3DGame.OpenGLVisualizer
{
    public partial class Form1 : Form
    {
        ...
        {
            Action action;
            if (keyActions.TryGetValue(keyData, out action))
            {
                action();
                canvas.Invalidate();
            }
		...
		//    get
		//    {
		//        // !!!!!!!!!!!!! магический стиль - разобраться что к чему
