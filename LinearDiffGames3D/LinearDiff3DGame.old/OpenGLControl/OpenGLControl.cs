...
namespace PopovYuri.Visualization
{
	/// <summary>
	/// The OpenGLControl class provides the basic functionality for user-defined 
	/// OpenGL controls.
	/// </summary>
	public unsafe class OpenGLControl : System.Windows.Forms.UserControl
	{
		#region Imports
        ...
        [DllImport("glu32.dll")]
        public unsafe static extern Byte* gluErrorString(UInt32 errCode);
        [DllImport("glu32.dll")]
        public static extern String gluErrorUnicodeStringEXT(UInt32 errCode);
        [DllImport("glu32.dll")]
        public unsafe static extern Byte* gluGetString(UInt32 name);
        [DllImport("glu32.dll")]
        ...
        [DllImport("glu32.dll")]
        public unsafe static extern void gluPickMatrix(Double x, Double y, Double width, Double height, Int32* viewport);
        [DllImport("glu32.dll")]
        ...
        [DllImport("glu32.dll")]
        public unsafe static extern Int32 gluProject(Double objx, Double objy, Double objz, Double* modelMatrix, Double* projMatrix, Int32* viewport, Double* winx, Double* winy, Double* winz);
        [DllImport("glu32.dll")]
        public unsafe static extern Int32 gluUnProject(Double winx, Double winy, Double winz, Double* modelMatrix, Double* projMatrix, Int32* viewport, Double* objx, Double* objy, Double* objz);
        [DllImport("glu32.dll")]
        public unsafe static extern Int32 gluScaleImage(UInt32 format, Int32 widthin, Int32 heightin, UInt32 typein, void* datain, Int32 widthout, Int32 heightout, UInt32 typeout, void* dataout);
        [DllImport("glu32.dll")]
        public unsafe static extern Int32 gluBuild1DMipmaps(UInt32 target, Int32 components, Int32 width, UInt32 format, UInt32 type, void* data);
        [DllImport("glu32.dll")]
        public unsafe static extern Int32 gluBuild2DMipmaps(UInt32 target, Int32 components, Int32 width, Int32 height, UInt32 format, UInt32 type, void* data);
        ...
        [DllImport("glu32.dll")]
        public unsafe static extern void gluDeleteQuadric(GLUquadric* state);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluQuadricNormals(GLUquadric* quadObject, UInt32 normals);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluQuadricTexture(GLUquadric* quadObject, Byte textureCoords);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluQuadricOrientation(GLUquadric* quadObject, UInt32 orientation);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluQuadricDrawStyle(GLUquadric* quadObject, UInt32 drawStyle);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluCylinder(GLUquadric* qobj, Double baseRadius, Double topRadius, Double height, Int32 slices, Int32 stacks);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluDisk(GLUquadric* qobj, Double innerRadius, Double outerRadius, Int32 slices, Int32 loops);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluPartialDisk(GLUquadric* qobj, Double innerRadius, Double outerRadius, Int32 slices, Int32 loops, Double startAngle, Double sweepAngle);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluSphere(GLUquadric* qobj, Double radius, Int32 slices, Int32 stacks);
        /*[DllImport("glu32.dll")]
        public unsafe static extern void gluQuadricCallback(GLUquadric* qobj, UInt32 which, void (CALLBACK* fn)());*/
        [DllImport("glu32.dll")]
        public unsafe static extern GLUtesselator* gluNewTess();
        [DllImport("glu32.dll")]
        public unsafe static extern void gluDeleteTess(GLUtesselator* tess);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluTessBeginPolygon(GLUtesselator* tess, void* polygon_data);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluTessBeginContour(GLUtesselator* tess);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluTessVertex(GLUtesselator* tess, Double* coords, void* data);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluTessEndContour(GLUtesselator* tess);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluTessEndPolygon(GLUtesselator* tess);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluTessProperty(GLUtesselator* tess, UInt32 which, Double value);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluTessNormal(GLUtesselator* tess, Double x, Double y, Double z);
        /*[DllImport("glu32.dll")]
        public unsafe static extern void gluTessCallback(GLUtesselator* tess, UInt32 which, void (CALLBACK *fn)());*/
        [DllImport("glu32.dll")]
        public unsafe static extern void gluGetTessProperty(GLUtesselator* tess, UInt32 which, Double* value);
        [DllImport("glu32.dll")]
        public unsafe static extern GLUnurbs* gluNewNurbsRenderer();
        [DllImport("glu32.dll")]
        public unsafe static extern void gluDeleteNurbsRenderer(GLUnurbs* nobj);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluBeginSurface(GLUnurbs* nobj);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluBeginCurve(GLUnurbs* nobj);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluEndCurve(GLUnurbs* nobj);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluEndSurface(GLUnurbs* nobj);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluBeginTrim(GLUnurbs* nobj);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluEndTrim(GLUnurbs* nobj);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluPwlCurve(GLUnurbs* nobj, Int32 count, Single* array, Int32 stride, UInt32 type);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluNurbsCurve(GLUnurbs* nobj, Int32 nknots, Single* knot, Int32 stride, Single* ctlarray, Int32 order, UInt32 type);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluNurbsSurface(GLUnurbs* nobj, Int32 sknot_count, Single* sknot, Int32 tknot_count, Single* tknot, Int32 s_stride, Int32 t_stride, Single* ctlarray, Int32 sorder, Int32 torder, UInt32 type);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluLoadSamplingMatrices(GLUnurbs* nobj, Single* modelMatrix, Single* projMatrix, Int32* viewport);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluNurbsProperty(GLUnurbs* nobj, UInt32 property, Single value);
        [DllImport("glu32.dll")]
        public unsafe static extern void gluGetNurbsProperty(GLUnurbs* nobj, UInt32 property, Single* value);
        /*[DllImport("glu32.dll")]
