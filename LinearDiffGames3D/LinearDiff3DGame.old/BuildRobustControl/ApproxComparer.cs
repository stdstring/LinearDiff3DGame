...
{
    /// <summary>
    /// класс ApproxComparer применяется для приблизительного сравнения двух действительных чисел
    /// </summary>
    [Serializable]
    public class ApproxComparer
    {
        /// <summary>
        ...
        /// <summary>
        /// конструктор класса ApproxComparer; в нем (и только в нем) задается величина Epsilon
        /// </summary>
        /// <param name="epsilon">величина, определяющая точность приблизительного сравнения</param>
        public ApproxComparer(Double epsilon)
        {
